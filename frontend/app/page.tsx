...
export default function HomePage() {
  ...
  if (key === 'system') { window.location.href = '/system'; return; }
  if (key === 'customer-contracts') { window.location.href = '/customer-contracts'; return; }
  if (key === 'receive-refunds') { window.location.href = '/receive-refunds'; return; }
  setSelected(key);
