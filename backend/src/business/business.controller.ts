...
export class BusinessController {
  ...
  @Get('promotion-accounts/:id') promotionAccountDetail(@Param() params: BusinessIdParamDto, @Req() r: AuthenticatedRequest) { return this.promotionAccountService.getAccountById(params.id, r.user); }
  @Get('promotion-accounts/:id/transactions') promotionAccountTransactions(@Param() params: BusinessIdParamDto, @Query() query: PromotionAccountTransactionQueryDto, @Req() r: AuthenticatedRequest) { return this.promotionAccountService.listTransactions(params.id, query, r.user); }
  @Post('promotion-accounts/:id/credit') promotionAccountCredit(@Param() params: BusinessIdParamDto, @Body() dto: PromotionAccountCreditDto, @Req() r: AuthenticatedRequest) { return this.promotionAccountService.creditAccount(params.id, dto, r.user); }
  @Post('promotion-accounts/:id/refund') promotionAccountRefund(@Param() params: BusinessIdParamDto, @Body() dto: PromotionAccountRefundDto, @Req() r: AuthenticatedRequest) { return this.promotionAccountService.refundAccount(params.id, dto, r.user); }
