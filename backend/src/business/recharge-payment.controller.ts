...
import { BusinessIdParamDto, CreateRechargePaymentApplicationDto, RechargePaymentApplicationQueryDto, RejectRechargePaymentApplicationDto, UpdateRechargePaymentApplicationDto } from './business.dto';
...
export class RechargePaymentController {
  ...
  @Post() create(@Body() dto: CreateRechargePaymentApplicationDto, @Req() request: AuthenticatedRequest) { return this.service.create(dto, request.user); }
