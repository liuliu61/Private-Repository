...
import { PublicInvoiceTaskController } from './public-invoice-task.controller';
import { PublicInvoiceTaskService } from './public-invoice-task.service';

@Module({ imports: [PrismaModule, CommonModule, RebateModule, CashflowModule], controllers: [BusinessController, FinanceController, CustomerWalletController, ReceivingController, InvoiceController, InvoiceOcrController, PublicInvoiceTaskController, ServiceFeeReconciliationController], providers: [BusinessService, CustomerRebatePolicyService, SupplierRebatePolicyService, PolicyResolverService, ProcurementOrderService, ProfitCalculator, GrossProfitCalculator, SupplierCostCalculator, PromotionAccountService, FinanceOverviewService, RefundService, SettlementCenterService, ReconciliationCenterService, FinancialAdjustmentService, CustomerWalletService, ReceivingService, InvoiceService, InvoiceOcrService, PublicInvoiceTaskService, SourcingSettingService, ServiceFeeReconciliationService] })
