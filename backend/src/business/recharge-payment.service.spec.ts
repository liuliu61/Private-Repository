...
function fixture(organizationId = 'org-a') {
  ...
  const receive = { id: 'receive-a', receiveNo: 'RC-001', organizationId, customerId: 'customer-a', currency: 'CNY', amount: new Prisma.Decimal('30000.00'), status: 'CONFIRMED', customer: { id: 'customer-a', name: '客户A', customerCode: 'C001' } };
  ...
  return { service: new RechargePaymentService(prisma, scope), applications, getWhere: () => capturedWhere };
}
